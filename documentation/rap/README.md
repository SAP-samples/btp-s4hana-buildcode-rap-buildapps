...
6. [Expose Service](./service/README.md)
7. [Add Geo Coordinates Logic](./geo-logic/README.md)
8. [Add Behavior Artifacts](./behavior-definition/README.md)
9. [Fill In the Test Data](./fill-data/README.md)
10. [Test the RESTful ABAP Service](./test/README.md)
11. [Create destination for RESTful ABAP Service](./destination/README.md)
