...
43. **Select** the Alert component and **go** to ABC icon under dialog title and **follow the path**: Output value of another node > Update Record

![](../screenshots/Picture194.png)

44. **Select** Error and **Save** it

![](../screenshots/Picture195.png)


45. **Select** the next button: Set Status: Closed. **Select** Update record and **go** to X under Resource name

![](../screenshots/Picture149.png)


46. **Select** Incidents and **Save** it

![](../screenshots/Picture150.png)


47. **Click** on ABC icon under ID. **Go** to Data and Variables > Page parameter
...
48. **Select** IncidentID and **Save** it

![](../screenshots/Picture152.png)


49. **Go** to Custom object

![](../screenshots/Picture153.png)


50. **Click** on X under processor. **Go** to Data and Variables > Page variable

![](../screenshots/Picture154.png)


51. **Select** SelectedPartner and **Save** it
...
52. **Click** on X under status_code. **Go** to Static Value
...
54. **Click** on X under urgency_code. **Go** to Data and Variables > Page variable

![](../screenshots/Picture158.png)


55. **Select** SelectedUrgency and **Save** it
...
57. **Select** Create record and **Click** on X under Resource name

![](../screenshots/Picture161.png)


58. **Select** Conversation data entity and **Save** it

> All the conversations will be saved under this data entity

![](../screenshots/Picture162.png)

59. **Click** on the {} icon under record. **Go** to Formula
...
63. **Select** Record of Conversation using component tree. **Then**, go to Repeat with > Data and Variables > Data variable

![](../screenshots/Picture167.png)


64. **Select** COnversation1 and **Save** it

![](../screenshots/Picture168.png)


65. **Select** Text 11 component using component tree. Then, **click** on the ABC icon under Content

![](../screenshots/Picture169.png)


66. **Select** data item in repeat

![](../screenshots/Picture170.png)


67. **Select** message under current and **Save** it
...
69. **Select** the Alert component and go to ABC icon under dialog title and **follow the path**: Output value of another node > Update Record

![](../screenshots/Picture197.png)

70. **Select** Error and **Save** it
